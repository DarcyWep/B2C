...
@Component({
    selector: 'app-spc-course',
    templateUrl: './spc-course.component.html',
    styleUrls: ['./spc-course.component.css', '../app.component.css']
})
export class SpcCourseComponent implements OnInit {
    ...
    private getProductsToShow(){
        let subObj = this.productService.getProductsToShow('专业课').subscribe(
            res => {
                if(res['code'] == 1){ 
